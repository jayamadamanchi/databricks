...
# TODO
schema = StructType([StructField("SMS", StringType(), False)])
...
# TODO
schema2 = StructType([StructField("SMS",StructType([StructField("Address",StringType(),True),StructField("date",StringType(),True),StructField("metadata",StructType([StructField("name",StringType(),True)]))]))])
SMSDF2 = (spark.read
         .schema(schema2)
         .json("/mnt/training/UbiqLog4UCI/14_F/log*"))
display(SMSDF2)
